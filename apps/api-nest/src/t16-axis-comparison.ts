...
export function t16WritingGuide(_slot: Row, tone: "conversational" | "expert" = "conversational"): string {
  ...
  return [
    ...
    "- 각 후보는 한 문장으로 스치지 말고 최소 3~4문장으로, 그 학원만의 개성이 드러나게 소개한다. 소개는 `### 학원명` 바로 아래에서 시작하고, 카드의 첫인상이 그 학원의 개성이 되게 한다. 순서 예시: ① 확인된 후기가 있으면 그 학원의 분위기 한 문장으로 연다 — 근거는 인용 1건만이 아니라 그 학원에 제공된 후기 전체('수강생 리뷰' + '수강생 반응 근거')에서 찾되, 문장은 공통분모를 요약하지 말고 그 후기들에서 가장 구체적이고 그 학원다운 특징 하나를 살려 쓴다(좋은 예: \"도로주행에서 위트를 섞어 설명해 주는 분위기예요\", \"실수해도 격려를 받으며 자세히 배우는 분위기예요\", \"셔틀이 잘 되어 있어 부담 없이 다니기 좋은 곳이에요\"). 이 지침에서 쓰는 설명 용어(\"장면\"·\"특징\"·\"소재\" 등)를 문장에 그대로 옮겨 \"~하는 장면이 있는 분위기예요\" 같이 쓰지 말고, 위 좋은 예처럼 자연스러운 한 문장으로 쓴다. \"친절한 분위기예요\"·\"모르는 걸 묻고 배울 수 있는 분위기예요\"·\"차분히 설명을 듣고 질문하기 좋은 분위기예요\"처럼 어느 학원에나 그대로 붙는 일반형 문장은 쓰지 않는다. 글쓴이 말로, 단정형 직접 서술(\"~ 분위기예요\"·\"~ 곳이에요\")로 쓴다. \"인상이 담겨 있어요\"·\"~가 느껴져요\"·\"전해집니다\"처럼 한 겹 물러선 귀속 표현은 쓰지 않고, 학원 전체를 규정하는 평판 단정(\"친절한 학원\"·\"좋은 곳\")이 아니라 후기에 나온 장면·행동으로 묘사한다(예: \"모르는 걸 편하게 물어볼 수 있는 분위기예요\", \"수업 일정을 상의하기 편한 곳이에요\"). 소재는 후기에서 실제로 좋았던 경험·행동에서 고른다 — 후기가 강사·감독관에 따른 편차나 운(\"강사에 따라 다를 수 있다\"·\"운빨\"), 다른 리뷰·평점에 대한 언급(\"리뷰 보고 겁먹었는데\"·\"옛날 리뷰\"·\"별점 낮게 주신 분들\"), 불안·주저를 담고 있어도 그것을 개성 문장의 소재로 삼지 않는다(카드를 부정적 인상으로 열게 된다 — 원문 인용은 아래에 그대로 실리므로 독자가 직접 확인한다). 후기에 좋았던 경험이 전혀 없으면 개성 문장을 억지로 만들지 말고 ②로 연다. 후기가 없어도 ②로 연다 → ② 다른 학원과 실제로 다른 차별점(대형·견인까지 되는 종합 과정·넓은 셔틀 운행 지역·주말/야간 운영·야간·전화상담 가능 시간·실제 도로주행 코스·자체시험·소재지 특성 등 자료로 확인된 것 중 가장 두드러진 하나)을 잇는다 → ③ 그 차별점이 어떤 독자에게 어떤 의미인지 이어 준다. 분위기 문장은 이 소개에서 한 번만 쓰고, 기본 정보 불릿과 인용 사이에 따로 끼워 넣지 않는다. 카드 소개 산문 어디에도 '리뷰/후기'라는 단어로 후기를 가리켜 옮기지 않고(카드 맨 아래 인용이 출처를 밝힌다 — \"리뷰에는 ~담겨 있어요\"·\"~가 언급된 리뷰가 있는 만큼\" 식 대신 서술 금지), 원문에 없는 표현·형용사를 지어내지 않으며 제공된 후기에 실제 담긴 성격만 쓴다. 후보들이 수강료·과정·업종까지 비슷해 하드 팩트로는 차이가 거의 없는 군집이면(같은 지역 전문학원끼리 흔하다), 소재지·과정을 다시 나열해 개성인 척하지 말고 ①의 후기 인상과 ②의 미세한 실제 차이(운영·전화상담 시간, 도로주행 코스 등)에서 개성을 찾는다. 주소·전화·수강료·운영시간처럼 아래 기본 정보 불릿에 들어갈 사실은 소개 문장에서 그대로 되풀이하지 말고(불릿이 담당) 소개는 개성·차별점·의미에 집중한다. 자료에 없는 정보나 '입소문·인기·유명·합격 공식' 같은 미검증 평판은 만들지 말고, 없으면 상담에서 확인할 질문으로 남긴다.",
    ...
    "- 굵게(**) 표시는 이 글의 '각 학원 소개에서 부각할 관점'이 지목한 사실에 우선 쓴다 — 주말/야간이면 운영 시간, 셔틀이면 운행 지역, 비용이면 수강료 금액, 과정이면 면허 과정. 여기에 학원명 첫 등장 정도만 더한다. 학원 카드당 1~3개로 아껴 쓰고, 부가세·검정료·기준 시점 같은 고지 문구나 문장 대부분을 굵게 만들지 않는다.",
