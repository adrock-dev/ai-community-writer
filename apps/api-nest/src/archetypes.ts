  ...
  local_axis: {
    ...
    writing_guide: {
      ...
      region_overlay: [
        ...
        "도입은 두 문단으로 쓴다 — 첫 문단은 슬롯 페르소나가 처한 상황과 그때 생기는 궁금증을 2~3문장으로 구체적으로 그리고, 둘째 문단은 이 글이 어느 범위의 후보를 다루는지 한 문장으로 밝힌 뒤 무엇을 어떤 순서로 볼지 2~3문장으로 안내한다. 도입이 글에서 가장 얇은 섹션이 되지 않게 한다",
