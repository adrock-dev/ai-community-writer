...
export const ARCHETYPES: Record<string, Archetype> = {
  ...
  local_axis: {
    ...
    writing_guide: {
      core: [
        "확인된 후보만 소개하고 실제 후보 수보다 큰 숫자를 만들지 않는다",
      ...
      region_overlay: [
        ...
        "후보별로 '### 학원명' 소제목을 쓰고 확인된 사실만 짧게 정리한다. 실제 소재지는 사실로만 적고 추천 이유로 쓰지 않는다",
      ],
      structure: [
        "비교표를 앞쪽에 배치한다 — 열 구성은 아래 '비교 기준'이 지정한 것을 따른다",
        "후보별 '### 학원명' 소개 — 확인된 사실만, 카드마다 사진 1장",
        "'비교 기준'이 지정한 주제로 강조 섹션을 하나 둔다",
        "'필수 응답'이 지정한 질문에 답하는 섹션을 반드시 둔다",
        "마무리에서 페르소나 상황과 후보를 연결하고 상담·예약 CTA로 닫는다",
      ],
      structure_variant_labels: ["비교표 우선", "후보 소개 우선", "필수 응답 우선"],
      structure_variants: [
        [
          "첫 H2 또는 두 번째 H2 안에 비교표를 배치한다(열 구성은 '비교 기준'을 따른다)",
          "후보별 '### 학원명' 소개 — 확인된 사실만, 카드마다 사진 1장",
          "'비교 기준' 주제로 강조 섹션을 하나 둔다",
          "'필수 응답' 질문에 답하는 섹션을 둔다",
          "페르소나 상황과 후보를 연결하는 마무리 + 상담·예약 CTA",
        ],
        [
          "도입 뒤 곧바로 후보별 '### 학원명' 소개로 들어간다 — 확인된 사실만, 카드마다 사진 1장",
          "후보 소개를 마친 뒤 비교표로 정리한다(열 구성은 '비교 기준'을 따른다)",
          "'필수 응답' 질문에 답하는 섹션을 둔다",
          "'비교 기준' 주제로 강조 섹션을 하나 둔다",
          "페르소나 상황과 후보를 연결하는 마무리 + 상담·예약 CTA",
        ],
        [
          ...
          "그 답을 기준으로 비교표를 배치한다(열 구성은 '비교 기준'을 따른다)",
          "후보별 '### 학원명' 소개 — 확인된 사실만, 카드마다 사진 1장",
          "'비교 기준' 주제로 강조 섹션을 하나 둔다",
          "페르소나 상황과 후보를 연결하는 마무리 + 상담·예약 CTA",
        ],
