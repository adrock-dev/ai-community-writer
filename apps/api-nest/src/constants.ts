...
export const TEMPLATE_SPECS = {
  T01: { name: "지역 운전학원 BEST 비교", primary: ["region"], use_persona: true, modifier_count: 2, weight: 1.15, min_sv: 0, kind: "local_best", default_design: "comparison", default_direction: "지역 학원 후보를 비교표와 추천 기준으로 정리하고, 상담·비용·셔틀·면허 종류 확인으로 전환을 연결한다.", axis_tags: { persona: ["*"], modifier: ["*"] }, axis_values: { persona: ["운전면허학원 비교 중인 수강생", "가성비 좋은 학원을 찾는 수강생", "집 근처 학원을 찾는 수강생", "셔틀버스 이용 희망자", "야간반을 찾는 직장인", "주말만 가능한 직장인", "빠른 시험 일정이 필요한 수강생", "시험장과 가까운 학원을 찾는 수강생"], modifier: ["가까운", "셔틀편리", "비용절약", "야간반", "주말반", "상담전확인"] }, academy_types: ["exam_academy", "academy"] },
