...
export const TEMPLATE_SPECS = {
  ...
  T03: { name: "운전면허 가이드 총정리", primary: ["keyword"], use_persona: true, modifier_count: 1, weight: 0.95, min_sv: 0, kind: "general_guide", default_design: "editorial", default_direction: "운전면허 절차와 개념을 초보자도 이해하도록 총정리형으로 풀고, 단계별 확인 포인트를 제공한다.", axis_tags: { persona: ["*"], modifier: ["*"] }, axis_values: { persona: ["운전이 처음인 초보자", "처음 면허 따는 대학생", "출퇴근을 위해 면허가 필요한 직장인", "장롱면허 재도전", "육아를 위해 운전이 필요한 부모", "시험 일정이 궁금한 사용자"], modifier: ["비용절약", "필기시험부터", "상담전확인", "주말반"] }, keyword_filter: ["운전면허", "운전면허 합격", "운전면허 비용", "운전면허 준비물", "1종보통", "2종보통"] },
  ...
  T06: { name: "시험 단계 집중 BEST", primary: ["keyword"], use_persona: false, modifier_count: 0, weight: 0.9, min_sv: 0, with_intent: true, kind: "exam_best", default_design: "comparison", default_direction: "필기·기능·도로주행 등 시험 단계별 핵심을 집중적으로 정리하고, 준비 순서를 제시한다.", axis_tags: { intent: ["exam", "common"] }, axis_values: { intent: ["기능시험", "도로주행", "필기접수", "준비물"] }, keyword_filter: ["운전면허 필기시험", "운전면허 기능시험", "운전면허 도로주행"] },
  T07: { name: "지역 허브 총정리", primary: ["region"], use_persona: false, modifier_count: 0, weight: 1.25, min_sv: 0, with_intent: true, kind: "regional_hub", default_design: "local-guide", default_direction: "지역 단위로 학원·시험장·생활권 정보를 허브형으로 총정리해 지역 검색 의도를 폭넓게 충족한다.", axis_tags: { intent: ["select", "location", "common"] }, axis_values: { intent: ["근처학원", "비교추천", "비용확인", "셔틀확인", "준비물"] }, academy_types: ["exam_academy", "academy"], keyword_filter: ["운전면허학원", "운전면허", "운전면허시험장"] },
  T08: { name: "운전면허 필기시험 접수", primary: ["keyword"], use_persona: false, modifier_count: 0, weight: 1.08, min_sv: 0, with_intent: true, kind: "written_registration", default_design: "checklist", default_direction: "필기시험 접수 절차·준비물·일정 확인 방법을 단계별 체크리스트로 안내한다.", axis_tags: { intent: ["written", "common"] }, axis_values: { intent: ["필기접수", "준비물", "비용확인"] }, keyword_filter: ["운전면허 필기시험 접수"] },
