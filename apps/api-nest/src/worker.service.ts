...
- 독자가 스캔해서 판단하는 핵심 사실(이 글의 관점이 지목한 값 — 운영 시간·셔틀 운행 지역·수강료 금액·면허 과정 등 — 과 학원명 첫 등장)에 Markdown bold를 아껴 쓴다. 부가세·검정료·기준 시점·상담 확인 같은 고지 문구는 굵게 하지 않는다.
