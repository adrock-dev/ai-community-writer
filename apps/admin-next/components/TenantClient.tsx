...
function Overview({ tenant, counts, onTab }: { tenant: DomainConfig; counts: SlotCounts; onTab: (v: string) => void }) {
  return <div className="grid">
    ...
    <div className="grid grid-2">
      <div className="card card-pad"><h2>콘텐츠 기획</h2><p className="muted">{tenant.content_brief || "아직 기획 메모가 없습니다."}</p><button className="btn" onClick={() => onTab("plan")}>기획 열기</button></div>
